resource "aws_vpc" "main" {
  ...
  tags = {
    Name                                        = var.vpc_name
    "kubernetes.io/cluster/${var.cluster_name}" = "shared" # Required for EKS to discover VPC resources
  }
}
...
# NAT Gateway (One per availability zone is best practice for HA, but using 1 for cost efficiency in this example)
